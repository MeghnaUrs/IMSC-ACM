...
trainloader = data.DataLoader(training_dataset, batch_size = 128, num_workers = 8)
...
for epoch in range(iterations):
    ...
    for i,j in enumerate(train_iterator):
        ...
        status = '[{0}] loss = {1:0.5f} avg = {2:0.5f}'.format(epoch + 1, a_loss.item(), np.mean(epoch_losses))
